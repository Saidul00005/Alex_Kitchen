...
import FoodItemsData from "@/data/vegetarianFoodData.json";
...
interface VegetarianFoodStoreState {
    foodItems: FoodItem[];
...
export const useVegetarianFoodStore = create<VegetarianFoodStoreState>()(
    devtools(
        persist(
            (set) => ({
