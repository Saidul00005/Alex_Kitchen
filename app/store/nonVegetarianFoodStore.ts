...
import FoodItemsData from "@/data/nonVegetarianFoodData.json";
...
interface NonVegetarianFoodStoreState {
    foodItems: FoodItem[];
...
export const useNonVegetarianFoodStore = create<NonVegetarianFoodStoreState>()(
    devtools(
        persist(
            (set) => ({
