                ...
                <>
                        < Navbar onMenuOpenChange={setIsMenuOpen} isBlurred={true}>
                                <NavbarContent>
                                        ...
                                        />
                                        <NavbarBrand>
                                                <p className="text-inherit md:text-xl mx-2 font-mono font-semibold">Alex Kitchen</p>
                                        </NavbarBrand>
                                </NavbarContent>
                        ...
                        <div className='flex justify-center'>
                                <div className='hidden md:block dark:bg-green-800 bg-slate-800  dark:opacity-75 opacity-15 h-1 w-3/4'>
                                </div>
                        </div>
                </>
        );
